...
・インターネット無料（ネット無料／Wi-Fi無料／無料インターネット／光回線無料）がある場合 → （オススメポイント）の箇条書きの一番下（最後の行）に1行入れる（他のポイントより優先度低め）。表現例「インターネット無料で毎月の通信費も節約出来ます！！」「Wi-Fi無料で月々のお支払いコストも抑えられます！！」。（設備）欄にも重ねて列挙してよい。※「月額〇〇円お得」「年間〇〇円節約」等の金額換算は引き続き絶対禁止
