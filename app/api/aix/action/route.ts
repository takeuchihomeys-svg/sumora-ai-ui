...
・サマリー文・描写段落・設備説明段落は出力しない（オススメポイントの箇条書きで全て伝える）

【絶対禁止ルール】
・バルコニー付きはオススメポイントに書かない（全物件共通のため）
・エレベーターはオススメポイントに書かない（全物件共通のため）
・保証金はオススメポイントに書かない（初期コストであり強みではない）
・礼金○ヶ月（1ヶ月以上）はオススメポイントに書かない。礼金0円・敷金礼金0円の場合のみオススメポイントとして記載可
...
・オススメポイントの後にサマリー文・描写段落・設備説明段落を追加しない（絶対禁止）
...
【出力例（申込モード）】
${jstHourNow >= 21 ? "[お客様名]さん夜分遅くに失礼致します！！" : "[お客様名]さんお待たせ致しました！！"}

梅田・難波周辺から[お客様名]さんご希望のご条件に合ったお部屋ピックアップさせて頂きました！！
...
Rさんお気に召されましたらお部屋ご都合よろしいお日にちにお部屋ご案内させて頂きます😊！！
