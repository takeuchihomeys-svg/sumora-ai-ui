...
・条件のでっち上げ禁止。希望条件データにない条件は絶対に書かない
例：「新着で梅田まで30分圏内のエリア全域から${name}にオススメできる2LDK・2口ガスコンロ付きの9/1入居可能なお部屋が3件募集にでました！！」
...
新着で梅田まで30分圏内のエリア全域から${name}にオススメできる2LDK・2口ガスコンロ付きのお部屋が${newArrivalCountStr}募集にでました！！
