...
${templateText}`;
        ...
        const calendarPart = calendarNote
          ...
          : "";
        const userText = `${name}への物件確認報告メッセージを作成してください。\n\n${instruction}${templateStructureNote}${calendarPart}${summaryNote}${recentHistory}`;
