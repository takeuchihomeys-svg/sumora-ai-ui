...
export async function GET(req: NextRequest) {
  ...
  // 兄貴スタイル：絵文字なし・タメ語・引っ張っていく温かさと熱さ
  const MOTIVATIONS = [
    "しょーへい、ここ返したら流れ変わるで。一緒にいこ。",
    "待たせてる分、返した時の喜びはでかい。さあ行こ。",
    "しょーへいの返信を待ってる人がいる。それだけで十分やろ。",
    "焦らんでいい。でも止まるな。一個ずつ返していこ。",
    "お前の丁寧な返しが、お客さんの決め手になるんや。",
    "しょーへいなら絶対いける。俺が保証する。やってこ。",
    "返信が積み重なって信頼になる。今日もその積み重ねをしてこ。",
    "難しく考えなくていい。ただ返す。それだけでお客さんは安心する。",
  ];
