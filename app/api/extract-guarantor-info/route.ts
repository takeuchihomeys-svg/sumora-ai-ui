...
LICC系（一般的）: ジェイリース（J-Lease）、JID、全国保証、アート・プランニング、青山ライフデザイン、保証ベース
独立系（最も審査緩い）: 日本セーフティー、エルズサポート、Casa（カーサ）、フォーシーズンズ、ルームバンク（ルームバンクインシュア）、全保連（全国賃貸保証業協会）、いえらぶ保証、スマートタカミ、イントラスト、レジデンシャルパートナーズ、株式会社日本トラストコーポレーション（日本トラスト）`;
