...
function detectAixTiming(
  ...
  if (AIX_CONDITION_CHANGE_RE.test(msg)) {
    return {
      ...
      bridge: "かしこまりました！！〇〇（顧客の言った新条件を復唱）のご条件に合ったお部屋を△△周辺からピックアップしてお送りさせて頂きます😊！！ピックアップ出来次第ご連絡させて頂きます！！",
      extra: "顧客の言った新条件を必ず復唱すること（実例: 「リビングとベッドを仕切れる1LDK・1DKの間取りや広めの1Kのお部屋を堀江・桜川・大国町周辺からピックアップしてお送りさせて頂きます😊！！」）。エリアの呼び方は顧客が使った表現をそのまま使い「全域」等を勝手に付け足さない。",
    };
  }
