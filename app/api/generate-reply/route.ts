...
const PHASE_GUIDE: Record<string, string> = {
  first_reply: `▶ 今すべきこと: 挨拶 + 条件ヒアリング開始（初回以外は自己紹介不要）
例: 「〇〇さん、お世話になっております😊！ご希望のお部屋探しのご条件をお教えいただけますでしょうか！」
...
例: 「〇〇さん、かしこまりました！書類の準備ができましたらお知らせください！スムーズに進めさせて頂きます😊！」`,
...
・承認・了解: 「かしこまりました！」で即アクション宣言（余計な説明しない）
