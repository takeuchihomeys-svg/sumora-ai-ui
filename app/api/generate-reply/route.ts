...
・名義貸し: 契約名義人（名義を貸す人）が主契約者となり、実際の入居者（同居人扱い）は従となる。【リスク①】名義人が先に出ていく場合は保証会社・管理会社による再審査が必要で、審査不通過なら退去になりうる。【リスク②】婚約者と偽った名義貸しは契約上の虚偽告知・違約金発生のリスクあり。【代替案】実際の入居者本人名義で申込む（収入が不足なら親族の代理契約も可能）こと、または入居者が保証人に入ることを提案する`.trim();
