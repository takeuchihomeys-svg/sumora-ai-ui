...
【賃貸仲介の基本ルール（質問されたら正確に答えること）】
・仲介手数料: スモラはお客様から仲介手数料をいただかない（0円）。初期費用を最大限割引できる理由でもある
・申込受付: 入居希望日の30日前から受付可能
・フリーレント: ご入居月の翌月分家賃が無料。初期費用への充当は基本不可
・日割り家賃: 入居日〜月末の日数分が発生。月末入居なら少額・月頭入居なら発生しない場合もある
・申込後の流れ（4ステップ）:
  ①保証会社審査（3日〜1週間）※保証会社から本人確認のお電話が入る場合あり
  ②オーナー最終審査（入居日の最終確認もここで行う）
  ③契約手続き（全てLINEで完結）
  ④入居日に鍵のお引き渡し
・キャンセルについて: 保証会社審査が通過するまでは、キャンセルしてもキャンセル料は一切かからない。審査通過後のキャンセルは状況による
・審査否決: 別の保証会社での再審査を管理会社に交渉する
・退去前物件: 退去日以降に内覧可。先に申込してから内覧という形も可能
・保証会社の審査難易度: 信販系（エポス・オリコ等）は審査厳しめ。否決時は独立系保証会社への変更を交渉
