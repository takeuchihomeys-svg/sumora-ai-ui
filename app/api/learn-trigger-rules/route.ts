...
const STOP_NGRAMS = new Set([
  ...
  // 申込書フォーム断片（AIX送信文のn-gramが誤学習しないよう除外）
  "氏名フリ", "名フリガ", "フリガナ", "生年月日", "現住所", "住民票",
  "記入欄", "入居希望", "希望日", "申込者", "込者様", "者様記",
  "入欄", "年月日", "希望家賃", "以内で", "ールア", "とのこと",
  "ますので", "承知しまし", "広げて", "やすい", "ライン", "出来る",
  "電車一本", "の物件は", "物件は", "条件に", "で家賃",
]);
