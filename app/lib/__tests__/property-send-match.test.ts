...
import { extractPropertySendThreads, buildPropertySendThreadsBlock, stripViewingInviteLines } from "../property-send-match";
...
it("糸口が無ければブロックは「無し」", () => {
  expect(buildPropertySendThreadsBlock({ customer: [], staff: [] })).toContain("無し");
});
