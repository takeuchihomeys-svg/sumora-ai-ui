...
console.log("■ 家賃: 上限内 +15 ／ 広げた検索の幅 +10 ／ 幅の外 1.10 まで 0 ／ 1.10 超は保留");
{
  ...
  t("家賃 85,000円＋管理費5,000円＝90,000円（1.125）→ 保留 RENT_OVER_110", code("85,000円 5,000円") === "RENT_OVER_110");
  t("家賃 80,000円＋管理費10,500円＝90,500円（1.13）→ 保留 RENT_OVER_110", code("80,000円 10,500円") === "RENT_OVER_110");
