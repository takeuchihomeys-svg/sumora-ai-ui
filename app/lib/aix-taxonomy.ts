...
export const AIX_BUTTON_LABELS: Record<string, string> = {
  ...
  property_recommendation: "1件特にオススメする",
...
export const AIX_STAFF_NOTES: Record<string, string> = {
  ...
  property_recommendation: "AIX【1件特にオススメする】を押してください: 同棟別号室の依頼・「初期費用を抑えたい」等、条件に最も合う1件に絞って再提案する場面です。1件に絞った詳細訴求文を生成します",
  ...
  greeting_viewing:        "AIX【挨拶（内覧前後）】を押してください: 内覧当日・前後の挨拶/フォローの場面です。シーンに合わせたフォローメッセージを生成します",
