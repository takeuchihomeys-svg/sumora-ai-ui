...
export const CONFIRM_OBJECT_LABELS: Array<[RegExp, string]> = [
  ...
  // 2026-09-23 反証者の指摘: ラベルに「家賃」を入れると、礼金・フリーレントを聞かれただけでも route が本文に「家賃…交渉」を必ず書けと指示していた
  //   （家賃の値下げ交渉はこちらから言わない・実送信0件）。ラベルから家賃の語を落とす
  [/(?:家賃|賃料|礼金|敷金|初期費用)[^\n]{0,8}(?:交渉|下げ|安く|値引|相談)|フリーレント|値引き|値下げ/, "費用・条件交渉の可否"],
