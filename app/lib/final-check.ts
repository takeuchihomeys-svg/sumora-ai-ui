...
【例外2】お客様が物件の画像・スクリーンショットを送ってきた文脈での「最大限割引させていただいた御見積書をお送りします（見積もり宣言）」と「〇〇周辺からご条件に合った物件をピックアップしてお送りします（ピックアップ宣言）」の組み合わせは AIX_BOUNDARY_PROMISE に該当しません（物件スクショ受信時の複合宣言は許可）。
