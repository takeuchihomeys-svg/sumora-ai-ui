...
【例外2】お客様が物件の画像・スクリーンショットを送ってきた文脈での「最大限割引させていただいた御見積書をお送りします（見積もり宣言）」と「〇〇周辺からオススメできる物件をピックアップしてお送りします（ピックアップ宣言）」の組み合わせは AIX_BOUNDARY_PROMISE にも RULE_VIOLATION にも該当しません（物件スクショ受信時の複合宣言は許可）。
...
- 「見積もりをお送りします」→「改めてご連絡いたします」
- 「〇〇号室の空室状況をお調べします」→「改めてご連絡いたします」
※ 置き換え文に「確認して〜ご連絡」の形は使わないこと（AIX【確認します】との二重宣言ガードに掛かり修正が破棄される）。「改めてご連絡いたします」で統一する。
