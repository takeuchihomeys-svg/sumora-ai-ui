...
export const STAFF_CONDITION_ASK_RE = /お部屋お探し中|ご希望のお部屋探しご条件|①【?ご入居(?:の)?時期|ご希望(?:の)?(?:ご)?条件(?:を|について|など|等)?(?:お聞かせ|教えて|お伺い|伺わせ|お送り(?:ください|下さい|頂け|いただけ)|ご入力|ご記入)|ご希望の(?:エリア|地域)(?:を|は|など)?(?:お聞かせ|教えて|お伺い)|条件(?:を)?お聞かせ|ご(?:入力|記入)(?:頂|いただ)/;
