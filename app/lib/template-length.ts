...
export function buildLengthNote(action: string | null | undefined): string {
  ...
  return [
    ...
    // 2026-09-21 YUMA の検証で懸念への2通目が「防犯面**気になりますよね**😌」と書いた。
    //   実測（scripts/audit-empathy-2nd.ts）: AIX の2通目1,424通で**0通**・スタッフ送信全体でも0.01%。
    `・⛔ 気持ちの代弁・同調（「〜ますよね」「ご心配かと思います」「お気持ちよくわかります」）は書かない。`,
    `　実送信の2通目1,424通で**0通**。気持ちに触れず、事実と次にこちらがやることで応える。`,
    ``,
    `■ 長さ`,
