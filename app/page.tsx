...
export default function Home() {
  ...
  const SITUATION_PROMPTS: Record<string, string> = {
    ...
    "確認する": "【確認指示】お客様が気になっていること・依頼・要望を、スタッフ側がしっかり確認・把握したことを伝える表現を自然に盛り込むこと（「確認させて頂きます！！」「しっかり確認した上でご提案させて頂きます！！」「承知致しました！！確認致します！！」など）。お客様にお願いする確認ではなく、こちら側が動く確認であることを明確にすること",
