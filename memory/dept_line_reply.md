...
- **未対応（竹内さんの判断待ち）**: 落ちた**26人分のデータの手当て**。会話は生きており（proposing / property_recommendation / viewing）、書かれていたエリアも全部残っている。作り直すなら過去のフォーム本文から `property_customers` を作る（売上番長への通知は出さない）
