...
| 2026-05-20 | 新メンバー追加: #43-GK（大阪地域博士・NEIGHBORHOOD_WARD_MAP守護者）・#43-AX・#43-RG・#43-WD・#43-WX |
...
| **#43-GK** | **大阪地域博士** ← 2026-05-20新設（大阪府全域の地名・町域を完全把握。`NEIGHBORHOOD_WARD_MAP`の守護者。itandi・リアプロ・レインズの地域検索を正確に支える） |
